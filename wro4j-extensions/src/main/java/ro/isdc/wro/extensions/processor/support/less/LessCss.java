 ...
 * The underlying implementation use patched less.js from version <code>1.4.0</code> project: {@link https
...
public class LessCss {
   ...
   */
  public static final String DEFAULT_LESS_JS = "less-1.4.0.min.js";
