...
public abstract class AbstractLinter {
  ...
  private RhinoScriptBuilder initScriptBuilder() {
    try {
      ...
      return createRhinoScriptBuilder().evaluateChain(getScriptAsStream(), "linter.js");
  ...
  /**
   * @return the {@link RhinoScriptBuilder} initialized for further chaining.
   */
  protected RhinoScriptBuilder createRhinoScriptBuilder() {
    return RhinoScriptBuilder.newChain();
  }
